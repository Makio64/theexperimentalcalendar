 ...
 */
(window._gsQueue||(window._gsQueue=[])).push(function(){_gsDefine("plugins.CSSPlugin",["plugins.TweenPlugin","TweenLite"],function(R){var w=function(){R.call(this,"css");this._overwriteProps.length=0},X,Y,s,Z,J={},l=w.prototype=new R("css");l.constructor=w;w.version=1.65;w.API=2;w.defaultTransformPerspective=0;l="px";w.suffixMap={top:l,right:l,bottom:l,left:l,width:l,height:l,fontSize:l,padding:l,margin:l,perspective:l};var $=/(?:\d|\-\d|\.\d|\-\.\d)+/g,ja=/(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g,
...
h.rotationY&&-1E-6<h.rotationY&&(h.rotationY=0));h.skewX=null==d.skewX?b.skewX:"number"===typeof d.skewX?d.skewX*E:L(d.skewX,b.skewX);h.skewY=null==d.skewY?b.skewY:"number"===typeof d.skewY?d.skewY*E:L(d.skewY,b.skewY);if(k=h.skewY-b.skewY)h.skewX+=k,h.rotation+=k;1E-6>h.skewY&&-1E-6<h.skewY&&(h.skewY=0);1E-6>h.skewX&&-1E-6<h.skewX&&(h.skewX=0);1E-6>h.rotation&&-1E-6<h.rotation&&(h.rotation=0)}n=b.z||b.rotationX||b.rotationY||h.z||h.rotationX||h.rotationY||h.perspective;!n&&null!=h.scale&&(h.scaleZ=
1);if(C){if(oa){na=!0;if(""===g.zIndex&&(k=v(a,"zIndex",s),"auto"===k||""===k))g.zIndex=0;pa&&(g.WebkitBackfaceVisibility=d.WebkitBackfaceVisibility||(n?"visible":"hidden"))}}else g.zoom=1;f=new q(a,"transform",0,0,f,2);f.setRatio=n&&I?La:C?Ma:Ka;f.plugin=i;f.data=b;for(Z.pop();-1<--j;)if(e=za[j],m=h[e]-b[e],1E-6<m||-1E-6>m||null!=T[e])f=new q(b,e,b[e],m,f),f.xs0=0,f.plugin=i,c._overwriteProps.push(f.n);if((m=d.transformOrigin)||I&&n&&b.zOrigin)C?(m=(m||v(a,e,s,!1,"50% 50%"))+"",e=Aa,f=new q(g,e,
0,0,f,-1,"css_transformOrigin"),f.b=g[e],f.plugin=i,I?(k=b.zOrigin,m=m.split(" "),b.zOrigin=(2<m.length?parseFloat(m[2]):k)||0,f.xs0=f.e=g[e]=m[0]+" "+(m[1]||"50%")+" 0px",f=new q(b,"zOrigin",0,0,f,-1,f.n),f.b=k,f.xs0=f.e=b.zOrigin):f.xs0=f.e=g[e]=m):ga(m+"",b);return f.t===a?(f._next&&(f._next._prev=null),f._next):f},!0);p("boxShadow","0px 0px 0px 0px #999",null,!0,!0);p("borderRadius","0px",function(a,b,e,c,f){var b=this.format(b),c=["borderTopLeftRadius","borderTopRightRadius","borderBottomRightRadius",
"borderBottomLeftRadius"],i=a.style,d,g,j,h,k,m,n,l,q,p,t,r;l=parseFloat(a.offsetWidth);q=parseFloat(a.offsetHeight);b=b.split(" ");for(d=0;d<c.length;d++)this.p.indexOf("border")&&(c[d]=Q(c[d])),h=j=v(a,c[d],s,!1,"0px"),k=g=b[d],m=parseFloat(h),t=h.substr((m+"").length),(r="="===k.charAt(1))?(n=parseInt(k.charAt(0)+"1"),k=k.substr(2),n*=parseFloat(k),p=k.substr((n+"").length-(0>n?1:0))||""):(n=parseFloat(k),p=k.substr((n+"").length)),""===p&&(p=Y[e]||t),p!==t&&(h=D(a,"borderLeft",m,t),m=D(a,"borderTop",
m,t),"%"===p?(h=100*(h/l)+"%",j=100*(m/q)+"%"):"em"===p?(t=D(a,"borderLeft",1,"em"),h=h/t+"em",j=m/t+"em"):(h+="px",j=m+"px"),r&&(k=parseFloat(h)+n+p,g=parseFloat(j)+n+p)),f=W(i,c[d],h+" "+j,k+" "+g,!1,"0px",f);return f},!0,!1,xa("0px 0px 0px 0px",!1,!0));p("backgroundPosition","0 0",null,!1,!1,ga);p("backgroundSize","0 0",null,!1,!1,ga);p("perspective","0px",null,!0);p("perspectiveOrigin","50% 50%",null,!0);p("transformStyle","preserve-3d",null,!0);p("margin",null,x("marginTop,marginRight,marginBottom,marginLeft"));
