...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <meta name="author" content="Victor Pamelard">
        <meta name="description" content="SNOCKS made with love by Victor Pamelard for The Christmas Experiments.">
        <meta property="og:title" content="The Christmas Experiments - SNOCKS"/>
        <meta property="og:type" content="website"/>
        <meta property="og:url" content="http://christmasexperiments.com/18/"/>
        <meta property="og:image" content="http://christmasexperiments.com/img/facebook.jpg"/>
        <meta property="og:site_name" content="The Christmas Experiments - SNOCKS"/>
        <meta property="og:description" content="SNOCKS made with love by Victor Pamelard for The Christmas Experiments."/>
    ...
    <body style="overflow:hidden">
        <header style="border-bottom:solid 1px #EEE">
            <div class="center">
                ...
                <h2>
                    <a href="http://victorpamelard.com/" target='_blank'>
                        Day 18 - SNOCKS by Victor Pamelard
                    </a>
                </h2>
                <ul id="share">
        ...
        <iframe style="top:50px" src="http://88.190.47.89/victor_snocks/public/<?php if(isset($_GET["room"])) echo "?room=" . $_GET["room"];?>"></iframe>
